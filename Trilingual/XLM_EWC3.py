...
# 装载微调模型
model = XLMRobertaForSequenceClassification.from_pretrained("./XLM_CE_EWC_1e-5_result")
model.to(device)
...
def trainer(train_dataloader, validation_dataloader, test_dataloader, model, optimizer, scheduler, precision_matrices,
    ...
    output_dir2 = './XLM_CEF_EWC_1e-5_result/'
...
data_path3 = './Weibo_2/'
df_test3 = pd.read_csv(os.path.join(data_path3, "test.tsv"), delimiter='\t')
...
test_dataloader3 = tokentest(tokenizer, df_test3)
